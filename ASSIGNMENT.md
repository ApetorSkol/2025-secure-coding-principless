...
<!-- ### Sub-command `parse-descriptor` -->

<!-- ``` -->
<!-- parse-descriptor {descriptor} [-] -->
<!-- ``` -->

<!-- The `parse-descriptor` implements parts of the [BIP 380](https://github.com/bitcoin/bips/blob/master/bip-0380.mediawiki) specification. -->
